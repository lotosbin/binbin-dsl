...
namespace Com.Lotos.BinbinDomainLanguage
{
	...
	/// </summary>
	internal partial class BinbinDomainLanguageDocData : BinbinDomainLanguageDocDataBase
	{
		/// <summary>
		/// Constructs a new BinbinDomainLanguageDocData.
		/// </summary>
		public BinbinDomainLanguageDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a BinbinDomainLanguage document in memory.
	/// </summary>
	internal abstract partial class BinbinDomainLanguageDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new BinbinDomainLanguageDocDataBase.
		/// </summary>
		protected BinbinDomainLanguageDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Com.Lotos.BinbinDomainLanguage.DominDriveDesignModel modelRoot = null;
			...
			global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Com.Lotos.BinbinDomainLanguage.DominDriveDesignModel modelRoot = (global::Com.Lotos.BinbinDomainLanguage.DominDriveDesignModel)this.RootElement;
			...
			{
				global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageDiagram diagram = diagrams[0] as global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Com.Lotos.BinbinDomainLanguage.DominDriveDesignModel modelRoot = this.RootElement as global::Com.Lotos.BinbinDomainLanguage.DominDriveDesignModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
