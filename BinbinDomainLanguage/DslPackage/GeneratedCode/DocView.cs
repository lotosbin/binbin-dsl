...
namespace Com.Lotos.BinbinDomainLanguage
{
	...
	/// </summary>
	internal partial class BinbinDomainLanguageDocView : BinbinDomainLanguageDocViewBase
	{
		/// <summary>
		/// Constructs a new BinbinDomainLanguageDocView.
		/// </summary>
		public BinbinDomainLanguageDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class BinbinDomainLanguageDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new BinbinDomainLanguageDocView.
		/// </summary>
		protected BinbinDomainLanguageDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			BinbinDomainLanguageDocDataBase docData = this.DocData as BinbinDomainLanguageDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for BinbinDomainLanguageDocViewBase should be an BinbinDomainLanguageDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.BinbinDomainLanguageDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
