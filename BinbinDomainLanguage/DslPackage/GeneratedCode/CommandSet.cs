...
namespace Com.Lotos.BinbinDomainLanguage
{
	...
	/// </summary>
	internal partial class BinbinDomainLanguageCommandSet : BinbinDomainLanguageCommandSetBase
	{
		/// <summary>
		/// Constructs a new BinbinDomainLanguageCommandSet.
		/// </summary>
		public BinbinDomainLanguageCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class BinbinDomainLanguageCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new BinbinDomainLanguageCommandSetBase.
		/// </summary>
		protected BinbinDomainLanguageCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewBinbinDomainLanguageExplorerCommand,
				typeof(BinbinDomainLanguageEditorFactory).GUID);
		...
		{
			BinbinDomainLanguageExplorerToolWindow explorer = this.BinbinDomainLanguageExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected BinbinDomainLanguageDocData CurrentBinbinDomainLanguageDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as BinbinDomainLanguageDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected BinbinDomainLanguageDocView CurrentBinbinDomainLanguageDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as BinbinDomainLanguageDocView;
			}
		}
		...
		/// </summary>
		protected BinbinDomainLanguageExplorerToolWindow BinbinDomainLanguageExplorerToolWindow
		{
			get
			{
				BinbinDomainLanguageExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(BinbinDomainLanguageExplorerToolWindow), true) as BinbinDomainLanguageExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				BinbinDomainLanguageExplorerToolWindow explorerWindow = this.BinbinDomainLanguageExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class BinbinDomainLanguageClipboardCommandSet : BinbinDomainLanguageClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new BinbinDomainLanguageClipboardCommandSet.
		/// </summary>
		public BinbinDomainLanguageClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class BinbinDomainLanguageClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new BinbinDomainLanguageClipboardCommandSetBase.
		/// </summary>
		protected BinbinDomainLanguageClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
