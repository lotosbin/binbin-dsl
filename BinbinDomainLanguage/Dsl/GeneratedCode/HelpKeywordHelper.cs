...
namespace Com.Lotos.BinbinDomainLanguage
{
	...
	/// </remarks>
	public partial class BinbinDomainLanguageHelpKeywordHelper : BinbinDomainLanguageHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new BinbinDomainLanguageHelpKeywordHelper.
		/// </summary>
		protected BinbinDomainLanguageHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the BinbinDomainLanguageHelpKeywordHelper.
		/// </summary>
		public static BinbinDomainLanguageHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class BinbinDomainLanguageHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new BinbinDomainLanguageHelpKeywordHelperBase.
		/// </summary>
		protected BinbinDomainLanguageHelpKeywordHelperBase()
			: base() { }
