...
namespace Com.Lotos.BinbinDomainLanguage
{
	...
	/// </remarks>
	public partial class BinbinDomainLanguageToolboxHelper : BinbinDomainLanguageToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new BinbinDomainLanguageToolboxHelper.
		/// </summary>
		public BinbinDomainLanguageToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class BinbinDomainLanguageToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify BinbinDomainLanguage toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "BinbinDomainLanguage.1.0";
		/// <summary>
		...
		/// <summary>
		/// Toolbox item filter string used to identify EntiyValueObjectRelationShip connector tool.
		/// </summary>
		public const string EntiyValueObjectRelationShipFilterString = "EntiyValueObjectRelationShip.1.0";
		...
		/// <summary>
		/// Constructs a new BinbinDomainLanguageToolboxHelperBase.
		/// </summary>
		protected BinbinDomainLanguageToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageDomainModel.SingletonResourceManager.GetString("BinbinDomainLanguageToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Com.Lotos.BinbinDomainLanguage.BinbinDomainLanguageDomainModel));
